export default function TraitsListHeader({ query, onQueryChange, sourceOptions, selectedSources, onToggleSource, onClearSources }) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
      <div>
        <h1 className="text-3xl sm:text-4xl font-bold">Черты</h1>
