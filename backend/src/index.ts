...
import { spellSchoolsRouter } from './domains/spellSchools/spellSchools.routes';
import { sourcesRouter } from './domains/sources/sources.routes';
import { traitsRouter } from './domains/traits/traits.routes';
import { backgroundsRouter } from './domains/backgrounds/backgrounds.routes';
...
app.use('/api/spell-schools', spellSchoolsRouter);
